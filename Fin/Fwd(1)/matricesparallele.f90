...
! calcul du nombre d'éléments non nuls dans la matrice
...
! construction de la matrice csr de taille 'diim'
				allocate (nnz(diim))
	...
	! vecteur contenant la solution initiale valant f et g au bord et 0 à l'intérieur du domaine
...
! vecteur contenant la fonction f
